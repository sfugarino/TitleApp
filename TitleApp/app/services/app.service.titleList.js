...
require('rxjs/Rx');
var AppServiceTitleList = (function (_super) {
    __extends(AppServiceTitleList, _super);
    function AppServiceTitleList(http) {
        var _this = this;
        _super.call(this, http);
        this.http = http;
        this._getTitleListUrl = 'api/Title';
    ...
    Object.defineProperty(AppServiceTitleList.prototype, "titleList", {
        get: function () {
            if (this._titleList) {
    ...
    AppServiceTitleList = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], AppServiceTitleList);
    return AppServiceTitleList;
}(HttpHelpers_1.HttpHelpers));
exports.AppServiceTitleList = AppServiceTitleList;
//# sourceMappingURL=app.service.titleList.js.map